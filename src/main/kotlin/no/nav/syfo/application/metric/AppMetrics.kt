...
val COUNT_METRIKK_PROSSESERING_VELLYKKET: Counter =
    Counter
...
val COUNT_METRIKK_DELT_MED_FASTLEGE: Counter =
    Counter
        .builder(METRIKK_DELT_MED_FASTLEGE)
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_FOLLOWUP_LPS_DELT_MED_FASTLEGE_TRUE: Counter =
    Counter
        .builder(METRIKK_FOLLOWUP_LPS_DELT_MED_FASTLEGE)
        .tags(TAG_FASTLEGE, "true")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_FOLLOWUP_LPS_DELT_MED_FASTLEGE_FALSE: Counter =
    Counter
        .builder(METRIKK_FOLLOWUP_LPS_DELT_MED_FASTLEGE)
        .tags(TAG_FASTLEGE, "false")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_BISTAND_FRA_NAV_TRUE: Counter =
    Counter
        .builder(METRIKK_BISTAND_FRA_NAV)
        .tags(TAG_BISTAND, "true")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_FOLLOWUP_LPS_BISTAND_FRA_NAV_TRUE: Counter =
    Counter
        .builder(METRIKK_FOLLOWUP_LPS_BISTAND_FRA_NAV)
        .tags(TAG_BISTAND_FOLLOWUP, "true")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_BISTAND_FRA_NAV_FALSE: Counter =
    Counter
        .builder(METRIKK_BISTAND_FRA_NAV)
        .tags(TAG_BISTAND, "false")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_FOLLOWUP_LPS_BISTAND_FRA_NAV_FALSE: Counter =
    Counter
        .builder(METRIKK_FOLLOWUP_LPS_BISTAND_FRA_NAV)
        .tags(TAG_BISTAND_FOLLOWUP, "false")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_FOLLOWUP_LPS_LPS_JOURNALFORT_TIL_GOSYS_TRUE: Counter =
    Counter
        .builder(METRIKK_FOLLOWUP_LPS_JOURNALFORT_TIL_GOSYS)
        .tags(TAG_GOSYS, "true")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_FOLLOWUP_LPS_LPS_JOURNALFORT_TIL_GOSYS_FALSE: Counter =
    Counter
        .builder(METRIKK_FOLLOWUP_LPS_JOURNALFORT_TIL_GOSYS)
        .tags(TAG_GOSYS, "false")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_DELT_MED_NAV_TRUE: Counter =
    Counter
        .builder(METRIKK_DELT_MED_NAV)
        .tags(TAG_DELT, "true")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_DELT_MED_NAV_FALSE: Counter =
    Counter
        .builder(METRIKK_DELT_MED_NAV)
        .tags(TAG_DELT, "false")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_FOLLOWUP_LPS_DELT_MED_NAV_TRUE: Counter =
    Counter
        .builder(METRIKK_FOLLOWUP_LPS_DELT_MED_NAV)
        .tags(TAG_DELT_FOLLOWUP, "true")
        .register(METRICS_REGISTRY)

val COUNT_METRIKK_FOLLOWUP_LPS_DELT_MED_NAV_FALSE: Counter =
    Counter
        .builder(METRIKK_FOLLOWUP_LPS_DELT_MED_NAV)
