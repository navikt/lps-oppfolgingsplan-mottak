...
fun nokkelopplysninger(skjemainnhold: Skjemainnhold) =
    Nokkelopplysninger(
        ...
        annenKontaktPersonFornavnEtternavn =
            FornavnEtternavn(
...
fun opplysningerOmArbeidstakeren(
    ...
    arbeidstakerenFornavnEtternavn =
        if (skjemainnhold.arbeidstakerHasNoName()) {
            null
        } else {
            FornavnEtternavn(
...
fun opplysingerOmSykefravaeret(skjemainnhold: Skjemainnhold) =
    if (
        ...
        OpplysingerOmSykefravaeret(
            ...
            sykmeldingsProsentVedSykmeldDato =
                skjemainnhold.sykefravaerForSykmeldtArbeidstaker
                    ?.sykmeldingsprosentVedSykmeldingsDato,
        )
    }

fun tiltak(skjemainnhold: Skjemainnhold) =
...
fun arbeidstakersDeltakelse(skjemainnhold: Skjemainnhold) =
